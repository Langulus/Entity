...
namespace Langulus::A
{
   ...
   Unit* Unit::SeekUnitAux(const Many& aux, DMeta meta, Index offset) {
   ...
   ///   @return the unit if found, or nullptr otherwise                      
   template<Seek SEEK> LANGULUS(INLINED)
   Unit* Unit::SeekUnitExt(DMeta type, const Many& ext, Index offset) {
   ...
   template<Seek SEEK> LANGULUS(INLINED)
   Unit* Unit::SeekUnitAuxExt(DMeta type, const Many& aux, const Many& ext, Index offset) {
   ...
   template<Seek SEEK> LANGULUS(INLINED)
   Langulus::Trait Unit::SeekTraitAux(const Many& aux, TMeta meta, Index offset) {
